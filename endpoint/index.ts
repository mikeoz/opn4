...
//
// This is the "front door" of Agent Safe. Any agent, platform, or developer
// can call this endpoint to verify an agent's trust status.
//
// Usage:
//   GET /functions/v1/verify-card?agent_id=urn:uuid:...
//   GET /functions/v1/verify-card?agent_id=urn:uuid:...&card_ref=urn:uuid:...
//
// Response: JSON object with entity_status, operator, active_use_cards,
//           and verified_at timestamp.
//
// Live URL: https://biejnguqnejzwmypotez.supabase.co/functions/v1/verify-card
// ============================================================================
